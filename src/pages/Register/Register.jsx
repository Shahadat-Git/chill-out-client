        ...
        <div className='container px-1 lg:mx-auto my-10 lg:w-8/12'>
            <div className='bg-base-200  rounded-lg px-5 py-10 lg:p-10 '>
                ...
                <form>
                    ...
                    <input className='block w-full h-16 text-2xl pl-5 focus:outline-warning my-2 rounded-lg' type="text" name='name' placeholder='Your Name' required />
                    ...
                    <input className='block w-full h-16 text-2xl pl-5 focus:outline-warning my-2 rounded-lg' type="text" name='password' placeholder='Your Photo URL' required />

                    <div className='flex justify-between'>
                        <Link to='/login' className='text-xl text-warning font-semibold underline  block hover:text-yellow-400'>Already have an account ?</Link>
                    </div>

                    <input className='btn btn-warning block w-full h-16 text-2xl mt-5 hover:bg-yellow-400' type="submit" value='Register' id="" />
