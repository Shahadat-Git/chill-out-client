                ...
                <div className='grid lg:grid-cols-2 gap-10 mx-auto max-w-fit'>
                    {
                        chefs ? chefs.map(chef => <ChefCard
                            chef={chef}
                            key={chef.chef_id}
                        ></ChefCard>) : <div role="status">
                            <svg aria-hidden="true" class="inline w-20h-20 h-20 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-warning" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
