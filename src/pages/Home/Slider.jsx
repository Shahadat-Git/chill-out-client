...
const Slider = () => {
    ...
    return (
        <div className="relative">
            ...
            >
                <SwiperSlide>
                    <div className="hero h-[75vh]" style={{ backgroundImage: `url("/banner/banner1.jpg")` }}>
                        <div className="hero-overlay bg-opacity-50"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div>
                                <h1 className="w-8/12 mx-auto mb-5 text-5xl font-bold">Indulge in All-Time Favorites</h1>
                ...
                <SwiperSlide>
                    <div className="hero h-[75vh]" style={{ backgroundImage: `url("/banner/banner2.jpg")` }}>
                        <div className="hero-overlay bg-opacity-50"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div>
                                <h1 className="w-8/12 mx-auto mb-5 text-5xl font-bold">Sweet Bliss Awaits</h1>
                ...
                <SwiperSlide>
                    <div className="hero h-[75vh]" style={{ backgroundImage: `url("/banner/banner3.jpg")` }}>
                        <div className="hero-overlay bg-opacity-50"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div>
                                <h1 className="w-8/12 mx-auto mb-5 text-5xl font-bold">A Mouthwatering Journey of Smoky Delights</h1>
            ...
            <div className="bg-center bg-cover absolute z-10 -bottom-1 w-full h-[40px] bg-no-repeat" style={{ backgroundImage: `url('/assets/shape-1.png')` }}>
            </div>
